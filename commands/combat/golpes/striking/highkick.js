...
module.exports = {
    ...
    outcomes: {
        GEM: {
            ...
            color: 0x9b59b6,
            texts: [
                "{attacker} chuta alto com flexibilidade impressionante e acerta a canela no pescoço/pescoço do oponente! Queda fulminante!",
        ...
        MISS: {
            ...
            texts: [
                ...
                "{attacker} perde o equilíbrio após o Highkick errar o alvo."
            ],
